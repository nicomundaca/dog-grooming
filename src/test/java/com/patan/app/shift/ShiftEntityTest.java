...
public class ShiftEntityTest extends Create {
    ...
    public void showShiftListState() {
        ...
        List<ShiftEntity> shiftEntityList = shiftService.getFilterdShift(requestShift, groomer);
        Assert.assertEquals(5, shiftEntityList.size());
        requestShift.setShiftState(null);
        List<ShiftEntity> shiftEntityList1 = shiftService.getFilterdShift(requestShift, groomer);
    ...
    public void showShiftListDate() {
        ...
        List<ShiftEntity> shiftEntityList2 = shiftService.getFilterdShift(requestShift, groomer);
        Assert.assertEquals(9, shiftEntityList2.size());
        List<ShiftEntity> shiftEntityList3 = shiftService.getFilterdShift(null, groomer);
    ...
    public void showShiftListTreatment() {
        ...
        List<ShiftEntity> shiftEntityList1 = shiftService.getFilterdShift(null, groomer);
        Assert.assertEquals(15, shiftEntityList1.size());
    }
