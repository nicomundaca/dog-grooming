...
public  class Create {
    ...
    protected User createUser(){
        ...
        Shift shift1 = new Shift(1L, 1L, date1, Treatment.BATHING, ShiftState.PENDING, 450, 2400, Lists.newArrayList());
        ...
        Shift shift5 = new Shift(2L, 5L, date5, Treatment.HAIRCUT_AND_BATHING, ShiftState.PENDING, 450, 2400, Lists.newArrayList());
        ...
        Shift shift7 = new Shift(2L, 7L, date7, Treatment.BATHING, ShiftState.CANCELLED, 0, 0, Lists.newArrayList());
        ...
        Shift shift12 = new Shift(5L, 12L, date12, Treatment.SCISSOR_HAIRCUT_AND_BATHING, ShiftState.DONE, 450, 2400, Lists.newArrayList());
        Date date13 = dateTime13.toDate();
        Shift shift13 = new Shift(5L, 13L, date13, Treatment.SCISSOR_HAIRCUT_AND_BATHING, ShiftState.DONE, 450, 2400, Lists.newArrayList());
